...
const jobReuseQuery = async (params, whereClause = "", statements = []) => {
  const { user_id, limit = 5, page = 1 } = params;
...
// export all the job.queries function to be able to br reuse in another functions
module.exports = {
  jobReuseQuery,
};
